...
DECLARE SOW_STATUS_GROWING                      INT             DEFAULT 4;

DECLARE cur_sow_id                              INT             DEFAULT 0;
DECLARE cur_sow_birth_of_date                   DATE            DEFAULT NULL;
...
DECLARE c_account_sow CURSOR FOR
    SELECT  id,
            date_of_birth
    FROM    sow_boar
...
loop_here: LOOP
    FETCH c_account_sow INTO 
        cur_sow_id,
        cur_sow_birth_of_date;
    ...
    INSERT INTO pig_prod_pig_ops(
        ...
        in_operation_type,
        DATE_ADD(cur_sow_birth_of_date, INTERVAL num_days_to_add DAY)
    );
