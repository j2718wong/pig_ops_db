...
DROP PROCEDURE IF EXISTS account_sow_due_chklst_delete_loop $$
CREATE PROCEDURE account_sow_due_chklst_delete_loop(
    in_account_id           INT,
...
loop_here: LOOP
    ...
    /** Create pf_sow_due_chklst_item entry*/
    DELETE FROM  pf_sow_due_chklst_item
    WHERE   pf_sow_due_chklst_id    = cur_pig_farm_chklst_id
        AND acc_sow_due_chklst_id   = in_account_chklst_id;
